...
const config: Config = {
  ...
  organizationName: 'deepalpharesearch', // Usually your GitHub org/user name.
  projectName: 'deepalpharesearch-website', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          // editUrl: 'https://github.com/deepalpharesearch/deepalpharesearch-website/tree/main/',
        },
        blog: {
